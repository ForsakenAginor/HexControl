...
namespace Assets.Scripts.BotLogic.StateMachine
{
    internal class MovingState : State
    {
        ...
        internal MovingState(
            Transform transform, float speed, ClaimSystem claimSystem, ToContestTransition toContestTransition, ToFinalTransition toFinalTransition)
