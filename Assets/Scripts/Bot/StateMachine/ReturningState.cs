...
namespace BotLogic
{
    internal class ReturningState : State
    {
        ...
        internal ReturningState(Transform transform, float speed, ClaimSystem claimSystem, ToDyingTransition toDyingTransition, ToMovingTransition toMovingTransition)
