...
namespace BotLogic
{
    internal class ContestState : State
    {
        ...
        internal ContestState(int contestLenth, Transform transform, float speed, ClaimSystem claimSystem, ToDyingTransition toDyingTransition, ToReturningTransition toReturningTransition)
